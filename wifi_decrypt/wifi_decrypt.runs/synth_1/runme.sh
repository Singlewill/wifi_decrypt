...
HD_PWD='/home/ll/workdir/fpga_test/VHDL/wifi_decrypt/wifi_decrypt/wifi_decrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WIFI_DECRYPT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WIFI_DECRYPT.tcl
